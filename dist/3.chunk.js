...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__general_user_works_work_model__ = __webpack_require__(966);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__general_user_works_designer_designer_model__ = __webpack_require__(964);
...
var AssignmentFormComponent = (function () {
    function AssignmentFormComponent(httpService, toaster) {
        ...
        this.workUpdated = new __WEBPACK_IMPORTED_MODULE_0__angular_core__["EventEmitter"]();
        // Requests to parent component the show of the danger modal to confirm if the contact is permanent removed.
        this.titleModal = new __WEBPACK_IMPORTED_MODULE_0__angular_core__["EventEmitter"]();
    ...
    **/
    AssignmentFormComponent.prototype.ngOnChanges = function () {
        ...
        if (!this.work) {
            // New work
            this.work = new __WEBPACK_IMPORTED_MODULE_4__general_user_works_work_model__["a" /* Work */]();
        }
        else {
            ...
            if (this.work.work_designers) {
                var _loop_1 = function (designer) {
                    // Show the designers assigned to the work
                    if (designer.active_work === true) {
                        var designer_complete = this_1.userList.filter(function (x) { return x.id === +designer.designer; })[0];
                        this_1.designerName = designer_complete.first_name + ' ' + designer_complete.last_name +
                            ' (' + designer_complete.groups_complete[0].name + ')';
                        this_1.designerListToSend.push(designer);
                        this_1.currentDesigner.push(this_1.convertToNgSelectFormat(designer.designer, this_1.designerName));
                    }
                };
                var this_1 = this;
                for (var _b = 0, _c = this.work.work_designers; _b < _c.length; _b++) {
                    var designer = _c[_b];
                    _loop_1(designer);
                }
            }
     ...
     */
    AssignmentFormComponent.prototype.convertToNgSelectFormat = function (designer_id, designer_name) {
        var designerObject = new __WEBPACK_IMPORTED_MODULE_5__general_user_works_designer_designer_model__["b" /* DesignerString */]();
    ...
    **/
    AssignmentFormComponent.prototype.submitWorkForm = function (form) {
    ...
    **/
    AssignmentFormComponent.prototype.submitUpdatedWork = function () {
        var _this = this;
        this.httpService.updateObject(__WEBPACK_IMPORTED_MODULE_3__environments_environment__["a" /* environment */].WORKS_URL + this.work.id + '/', this.work.generateJSONForPOST()).subscribe(function (result) {
            if (result.ok) {
                var updatedWork = new __WEBPACK_IMPORTED_MODULE_4__general_user_works_work_model__["a" /* Work */](result.json());
                _this.workUpdated.emit(updatedWork);
                _this.toaster.show(result, 'Trabajo actualizado', 'El trabajo se actualizó con éxito');
            }
        }, function (error) {
    ...
    **/
    AssignmentFormComponent.prototype.requestCloseThisModal = function () {
    ...
    **/
    AssignmentFormComponent.prototype.cancelForm = function (form) {
        this.ngOnChanges();
    };
    /**
    * Adds the selected element to the designerListToSend list.
    **/
    AssignmentFormComponent.prototype.selected = function (value) {
        // If it exists I change it's active_work attribute
        var designer = this.designerListToSend.filter(function (designer_aux) { return designer_aux.designer === value.id; })[0];
        var index = this.designerListToSend.indexOf(designer);
        if (index >= 0) {
            this.designerListToSend[index].active_work = true;
        }
        else {
            // If not, I create the new Designer.
            var designer_aux = new __WEBPACK_IMPORTED_MODULE_5__general_user_works_designer_designer_model__["a" /* Designer */]();
    ...
    **/
    AssignmentFormComponent.prototype.removed = function (value) {
        var designer = this.designerListToSend.filter(function (designer_aux) { return designer_aux.designer === value.id; })[0];
        var index = this.designerListToSend.indexOf(designer);
        if (index >= 0) {
            this.designerListToSend[index].active_work = false;
        }
        var designerString = this.currentDesigner.filter(function (designer_aux) { return designer_aux.designer === value.id; })[0];
        var indexString = this.currentDesigner.indexOf(designerString);
        if (indexString >= 0) {
...
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])('work'),
    __metadata("design:type", typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_4__general_user_works_work_model__["a" /* Work */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__general_user_works_work_model__["a" /* Work */]) === "function" && _a || Object)
], AssignmentFormComponent.prototype, "work", void 0);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])('userList'),
    __metadata("design:type", Array)
], AssignmentFormComponent.prototype, "userList", void 0);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])('designerListDefault'),
    __metadata("design:type", Array)
], AssignmentFormComponent.prototype, "designerListDefault", void 0);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Output"])(),
    __metadata("design:type", typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_0__angular_core__["EventEmitter"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__angular_core__["EventEmitter"]) === "function" && _b || Object)
], AssignmentFormComponent.prototype, "requestCloseModal", void 0);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Output"])(),
    __metadata("design:type", typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_0__angular_core__["EventEmitter"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__angular_core__["EventEmitter"]) === "function" && _c || Object)
], AssignmentFormComponent.prototype, "workUpdated", void 0);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Output"])(),
    __metadata("design:type", typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_0__angular_core__["EventEmitter"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__angular_core__["EventEmitter"]) === "function" && _d || Object)
], AssignmentFormComponent.prototype, "titleModal", void 0);
AssignmentFormComponent = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'assignment-form',
        template: __webpack_require__(1054)
    }),
    __metadata("design:paramtypes", [typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_1__shared_http_service_http_service__["a" /* HttpService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__shared_http_service_http_service__["a" /* HttpService */]) === "function" && _e || Object, typeof (_f = typeof __WEBPACK_IMPORTED_MODULE_2__shared_toast_custom_toast_service__["a" /* CustomToastService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__shared_toast_custom_toast_service__["a" /* CustomToastService */]) === "function" && _f || Object])
], AssignmentFormComponent);

var _a, _b, _c, _d, _e, _f;
//# sourceMappingURL=/Users/juanhernandez/Desktop/Balarco/src/assignment-form.component.js.map
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony export (binding) */ __webpack_require__.d(exports, "a", function() { return AssignmentsListComponent; });
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AssignmentsListComponent = (function () {
    function AssignmentsListComponent() {
        // Sends the request to show the update work modal in parent component.
        this.requestShowUpdateWorkModal = new __WEBPACK_IMPORTED_MODULE_0__angular_core__["EventEmitter"]();
        // Sends the work selected by the user to parent component.
        this.currentWork = new __WEBPACK_IMPORTED_MODULE_0__angular_core__["EventEmitter"]();
    ...
    **/
    AssignmentsListComponent.prototype.requestUpdateWorkModal = function () {
    ...
    **/
    AssignmentsListComponent.prototype.sendCurrentWork = function (object) {
    ...
    **/
    AssignmentsListComponent.prototype.filterItem = function (value) {
        this.valueSearch.emit(value);
    };
    return AssignmentsListComponent;
}());
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"])('worksList'),
    __metadata("design:type", Array)
], AssignmentsListComponent.prototype, "worksList", void 0);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Output"])(),
    __metadata("design:type", typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_0__angular_core__["EventEmitter"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__angular_core__["EventEmitter"]) === "function" && _a || Object)
], AssignmentsListComponent.prototype, "requestShowUpdateWorkModal", void 0);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Output"])(),
    __metadata("design:type", typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_0__angular_core__["EventEmitter"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__angular_core__["EventEmitter"]) === "function" && _b || Object)
], AssignmentsListComponent.prototype, "currentWork", void 0);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Output"])(),
    __metadata("design:type", typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_0__angular_core__["EventEmitter"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__angular_core__["EventEmitter"]) === "function" && _c || Object)
], AssignmentsListComponent.prototype, "valueSearch", void 0);
AssignmentsListComponent = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
...
var _a, _b, _c;
//# sourceMappingURL=/Users/juanhernandez/Desktop/Balarco/src/assignment-list.component.js.map
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony export (binding) */ __webpack_require__.d(exports, "a", function() { return CalculateDeliveryDatePipe; });
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
*/
var CalculateDeliveryDatePipe = (function () {
    function CalculateDeliveryDatePipe() {
    }
    CalculateDeliveryDatePipe.prototype.transform = function (date) {
        var today = new Date();
        var oneDay = 24 * 60 * 60 * 1000;
        var diffDays = Math.round(Math.abs((date.getTime() - today.getTime()) / (oneDay)));
        var diffHours = Math.round(Math.abs((date.getTime() - today.getTime()) / (oneDay / 24)));
    ...
    return CalculateDeliveryDatePipe;
}());
CalculateDeliveryDatePipe = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Pipe"])({ name: 'calculateDeliveryDate' })
], CalculateDeliveryDatePipe);

//# sourceMappingURL=/Users/juanhernandez/Desktop/Balarco/src/assignments-dates-format-table.pipe.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__designs_list_component__ = __webpack_require__(992);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__assignments_assignments_component__ = __webpack_require__(991);
/* harmony export (binding) */ __webpack_require__.d(exports, "a", function() { return DesignDirectorRoutingModule; });
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    {
        ...
        children: [
            {
                path: 'designs-list',
                component: __WEBPACK_IMPORTED_MODULE_3__designs_list_component__["a" /* DesignsListComponent */],
                data: {
                    title: 'Designs List'
                }
            },
            {
                path: 'assignments',
                component: __WEBPACK_IMPORTED_MODULE_4__assignments_assignments_component__["a" /* AssignmentsComponent */],
                data: {
                    title: 'Assignments'
                }
            }
...
//# sourceMappingURL=/Users/juanhernandez/Desktop/Balarco/src/design-director-routing.module.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__designs_list_component__ = __webpack_require__(992);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__assignments_assignments_component__ = __webpack_require__(991);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__assignments_assignment_list_component__ = __webpack_require__(1026);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__assignments_assignment_form_component__ = __webpack_require__(1025);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__design_director_routing_module__ = __webpack_require__(1028);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12_ng2_bootstrap_datepicker__ = __webpack_require__(969);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13_ng2_select__ = __webpack_require__(961);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__shared_http_service_http_service__ = __webpack_require__(475);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__shared_auth_auth_service__ = __webpack_require__(821);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__shared_toast_custom_toast_service__ = __webpack_require__(806);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17_ngx_pagination__ = __webpack_require__(963);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__assignments_assignments_dates_format_table_pipe__ = __webpack_require__(1027);
/* harmony export (binding) */ __webpack_require__.d(exports, "DesignDirectorModule", function() { return DesignDirectorModule; });
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
DesignDirectorModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_11__design_director_routing_module__["a" /* DesignDirectorRoutingModule */],
            ...
            __WEBPACK_IMPORTED_MODULE_12_ng2_bootstrap_datepicker__["a" /* DatepickerModule */].forRoot(),
        ...
        declarations: [__WEBPACK_IMPORTED_MODULE_7__designs_list_component__["a" /* DesignsListComponent */], __WEBPACK_IMPORTED_MODULE_8__assignments_assignments_component__["a" /* AssignmentsComponent */], __WEBPACK_IMPORTED_MODULE_9__assignments_assignment_list_component__["a" /* AssignmentsListComponent */],
            __WEBPACK_IMPORTED_MODULE_10__assignments_assignment_form_component__["a" /* AssignmentFormComponent */], __WEBPACK_IMPORTED_MODULE_18__assignments_assignments_dates_format_table_pipe__["a" /* CalculateDeliveryDatePipe */]],
        providers: [__WEBPACK_IMPORTED_MODULE_15__shared_auth_auth_service__["a" /* CanActivateAuthGuard */], __WEBPACK_IMPORTED_MODULE_14__shared_http_service_http_service__["a" /* HttpService */], __WEBPACK_IMPORTED_MODULE_16__shared_toast_custom_toast_service__["a" /* CustomToastService */]]
    })
], DesignDirectorModule);

//# sourceMappingURL=/Users/juanhernandez/Desktop/Balarco/src/design-director.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(exports, "a", function() { return Designer; });
/* harmony export (binding) */ __webpack_require__.d(exports, "b", function() { return DesignerString; });
/**
* Class that represents a Designer of a work for the API.
**/
var Designer = (function () {
    function Designer(object) {
...
**/
var DesignerString = (function () {
    function DesignerString() {
    }
    return DesignerString;
}());

//# sourceMappingURL=/Users/juanhernandez/Desktop/Balarco/src/designer-model.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(exports, "a", function() { return Status; });
/**
...
//# sourceMappingURL=/Users/juanhernandez/Desktop/Balarco/src/status-model.js.map
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__accounts_igualas_iguala_model__ = __webpack_require__(845);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__accounts_contacts_contact_model__ = __webpack_require__(844);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__art_works_art_work_model__ = __webpack_require__(839);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__work_type_work_type_model__ = __webpack_require__(973);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__status_status_model__ = __webpack_require__(965);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__designer_designer_model__ = __webpack_require__(964);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__admin_users_user_model__ = __webpack_require__(846);
/* harmony export (binding) */ __webpack_require__.d(exports, "a", function() { return Work; });
// Models
...
var Work = (function () {
    function Work(object) {
        if (object) {
            ...
            this.contact_complete = new __WEBPACK_IMPORTED_MODULE_1__accounts_contacts_contact_model__["a" /* Contact */](object.contact_complete);
            this.work_type = object.work_type;
            this.work_type_complete = new __WEBPACK_IMPORTED_MODULE_3__work_type_work_type_model__["a" /* WorkType */](object.work_type_complete);
            ...
            this.current_status_complete = new __WEBPACK_IMPORTED_MODULE_4__status_status_model__["a" /* Status */](object.current_status_complete);
            this.iguala = object.iguala;
            this.iguala_complete = new __WEBPACK_IMPORTED_MODULE_0__accounts_igualas_iguala_model__["a" /* Iguala */](object.iguala_complete);
            this.executive = object.executive;
            this.executive_complete = new __WEBPACK_IMPORTED_MODULE_6__admin_users_user_model__["a" /* User */](object.executive_complete);
            ...
            if (object.art_works) {
                for (var _i = 0, _a = object.art_works; _i < _a.length; _i++) {
                    ...
                    if (!artWork.name && artWork.art_type_complete) {
                        this.art_works.push(new __WEBPACK_IMPORTED_MODULE_2__art_works_art_work_model__["a" /* ArtWork */]({ id: artWork.art_type, name: artWork.art_type_complete.name, quantity: artWork.quantity }));
                    }
                    else {
                        this.art_works.push(new __WEBPACK_IMPORTED_MODULE_2__art_works_art_work_model__["a" /* ArtWork */](artWork));
                    }
                }
            }
            this.work_designers = [];
            if (object.work_designers) {
                for (var _b = 0, _c = object.work_designers; _b < _c.length; _b++) {
                    var work_design = _c[_b];
                    this.work_designers.push(new __WEBPACK_IMPORTED_MODULE_5__designer_designer_model__["a" /* Designer */](work_design));
                }
            }
        }
    }
    ...
    **/
    Work.prototype.generateJSONForPOST = function () {
        ...
        var workDesignersArray = [];
        if (this.work_designers) {
            if (this.work_designers.length > 0) {
                for (var _b = 0, _c = this.work_designers; _b < _c.length; _b++) {
                    var work_design = _c[_b];
...
//# sourceMappingURL=/Users/juanhernandez/Desktop/Balarco/src/work-model.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(exports, "a", function() { return WorkType; });
/**
* Class that represents a Work type:
* Iguala, Graduations or Projects.
**/
var WorkType = (function () {
    function WorkType(object) {
        this.id = object && object.id;
        this.name = object && object.name;
...
//# sourceMappingURL=/Users/juanhernandez/Desktop/Balarco/src/work-type-model.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__shared_http_service_http_service__ = __webpack_require__(475);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__shared_toast_custom_toast_service__ = __webpack_require__(806);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__admin_users_user_model__ = __webpack_require__(846);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__general_user_works_work_model__ = __webpack_require__(966);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__general_user_works_designer_designer_model__ = __webpack_require__(964);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__angular_http__ = __webpack_require__(287);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__environments_environment__ = __webpack_require__(282);
/* harmony export (binding) */ __webpack_require__.d(exports, "a", function() { return AssignmentsComponent; });
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AssignmentsComponent = (function () {
    ...
    **/
    AssignmentsComponent.prototype.ngOnInit = function () {
        ...
        this.loadWorksList(__WEBPACK_IMPORTED_MODULE_7__environments_environment__["a" /* environment */].WORKS_URL);
        this.loadUserList(__WEBPACK_IMPORTED_MODULE_7__environments_environment__["a" /* environment */].USERS_URL);
    };
    /**
    ...
    **/
    AssignmentsComponent.prototype.loadWorksList = function (url) {
        var _this = this;
        var params = new __WEBPACK_IMPORTED_MODULE_6__angular_http__["f" /* URLSearchParams */]();
        ...
        this.httpService.getObject(url, params)
            ...
            for (var _i = 0, worksListJSON_1 = worksListJSON; _i < worksListJSON_1.length; _i++) {
                ...
                _this.worksList.push(new __WEBPACK_IMPORTED_MODULE_4__general_user_works_work_model__["a" /* Work */](workJSON));
                _this.completeWorksList.push(new __WEBPACK_IMPORTED_MODULE_4__general_user_works_work_model__["a" /* Work */](workJSON));
            }
        }, function (error) {
    ...
    AssignmentsComponent.prototype.loadUserList = function (url) {
        ...
        this.httpService.getObject(url, params)
            ...
            for (var _i = 0, userListJSON_1 = userListJSON; _i < userListJSON_1.length; _i++) {
                ...
                _this.userList.push(new __WEBPACK_IMPORTED_MODULE_3__admin_users_user_model__["a" /* User */](userJSON));
                /* Assign to designerListDefault all the users with
                active_work: false */
                var designer = new __WEBPACK_IMPORTED_MODULE_5__general_user_works_designer_designer_model__["a" /* Designer */]();
        ...
        if (this.valueSearch === '') {
            ...
            for (var _i = 0, _a = this.completeWorksList; _i < _a.length; _i++) {
                ...
                if (workFromList.name.toLowerCase().includes(this.valueSearch.toLowerCase()) ||
                    ...
                    this.worksList.push(new __WEBPACK_IMPORTED_MODULE_4__general_user_works_work_model__["a" /* Work */](workFromList));
                }
            }
        }
    };
...
AssignmentsComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__shared_http_service_http_service__["a" /* HttpService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__shared_http_service_http_service__["a" /* HttpService */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_2__shared_toast_custom_toast_service__["a" /* CustomToastService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__shared_toast_custom_toast_service__["a" /* CustomToastService */]) === "function" && _b || Object])
], AssignmentsComponent);

var _a, _b;
//# sourceMappingURL=/Users/juanhernandez/Desktop/Balarco/src/assignments.component.js.map
