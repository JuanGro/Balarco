...
var ClientFormComponent = (function () {
    function ClientFormComponent(httpService) {
    ...
    ClientFormComponent.prototype.submitUpdatedClient = function (object, id) {
        var _this = this;
        this.httpService.updateObject(environment.CLIENTS_URL + id + '/', object).subscribe(function (result) {
            if (result.ok) {
    ...
    ClientFormComponent.prototype.submitNewClient = function (object) {
        var _this = this;
        this.httpService.postObject(environment.CLIENTS_URL, object).subscribe(function (result) {
            if (result.ok) {
