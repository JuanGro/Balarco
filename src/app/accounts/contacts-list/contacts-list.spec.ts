...
describe('ContactsListComponent (inline template)', () => {
    ...
    beforeEach(() => {
        ...
        const fixtureParent = TestBed.createComponent(ContactsListComponent);
        const fixtureChildForm = TestBed.createComponent(ContactsListFormComponent);
        const fixtureChildTable = TestBed.createComponent(ContactsListTableComponent);
